...
public class LoncotesLibraryDbContext : DbContext
{
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    modelBuilder.Entity<Checkout>().HasData(new Checkout[]
    {
      ...
      new Checkout {Id = 2, MaterialId = 2, PatronId = 2, CheckoutDate = new DateTime(2022, 1, 5), ReturnDate = new DateTime(2022, 1, 20), Paid = false},
      ...
      new Checkout {Id = 4, MaterialId = 4, PatronId = 4, CheckoutDate = new DateTime(2022, 3, 15), ReturnDate = new DateTime(2022, 3, 30), Paid = false},
      new Checkout {Id = 5, MaterialId = 5, PatronId = 5, CheckoutDate = new DateTime(2022, 4, 20), ReturnDate = new DateTime(2022, 5, 5), Paid = true},
      new Checkout {Id = 6, MaterialId = 6, PatronId = 6, CheckoutDate = new DateTime(2022, 5, 25), ReturnDate = new DateTime(2022, 6, 10), Paid = false},
      ...
      new Checkout {Id = 8, MaterialId = 8, PatronId = 8, CheckoutDate = new DateTime(2022, 7, 5), ReturnDate = new DateTime(2022, 7, 20), Paid = false},
      ...
      new Checkout {Id = 10, MaterialId = 10, PatronId = 10, CheckoutDate = new DateTime(2022, 9, 15), ReturnDate = new DateTime(2022, 9, 30), Paid = false},
      ...
      new Checkout {Id = 12, MaterialId = 2, PatronId = 12, CheckoutDate = new DateTime(2022, 11, 10), ReturnDate = new DateTime(2022, 11, 25), Paid = false},
      ...
      new Checkout {Id = 14, MaterialId = 4, PatronId = 2, CheckoutDate = new DateTime(2023, 1, 5), ReturnDate = new DateTime(2023, 1, 20), Paid = false},
      ...
      new Checkout {Id = 16, MaterialId = 6, PatronId = 4, CheckoutDate = new DateTime(2023, 3, 15), ReturnDate = new DateTime(2023, 3, 30), Paid = false},
      ...
      new Checkout {Id = 18, MaterialId = 8, PatronId = 6, CheckoutDate = new DateTime(2023, 5, 25), ReturnDate = new DateTime(2023, 6, 10), Paid = false},
      new Checkout {Id = 19, MaterialId = 9, PatronId = 7, CheckoutDate = new DateTime(2023, 6, 30), ReturnDate = new DateTime(2023, 7, 15), Paid = true},
      new Checkout {Id = 20, MaterialId = 10, PatronId = 8, CheckoutDate = new DateTime(2023, 7, 5), ReturnDate = new DateTime(2023, 7, 20), Paid = false},
    });
  }
}
